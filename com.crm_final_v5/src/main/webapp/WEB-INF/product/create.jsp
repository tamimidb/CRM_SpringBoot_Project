...
<script type="text/javascript">
	...
	JotForm
			.init(function() {
				...
				JotForm.calendarMonths = [ "January", "February", "March",
						"April", "May", "June", "July", "August", "September",
						"October", "November", "December" ];
				JotForm.calendarDays = [ "Sunday", "Monday", "Tuesday",
	...
	JotForm.prepareCalculationsOnTheFly([ null, null, null, null, null, null, {
		...
		"type" : "control_dropdown"
			...
			null, null, null, null, null, {
				...
				"qid" : "56",
				"subLabel" : "",
				"text" : "Product Weight Per Pieces",
				"type" : "control_number"
			}, {
				"description" : "",
				"name" : "productTotal",
...
<body>
	<form class="jotform-form"
		action="/product/save"
		method="post" name="form_212603360251442" id="212603360251442"
		...
		<div role="main" class="form-all">
			<ul class="form-section page-section">
				...
				<li class="form-line" data-type="control_textbox" id="id_49"><label
					class="form-label form-label-left form-label-auto" id="label_49"
					for="input_49"> Product Code </label>
				...
				<li class="form-line jf-required" data-type="control_dropdown"
					...
					for="input_16"> Parent Product <span class="form-required">
							* </span>
				</label>
					<div id="cid_16" class="form-input jf-required">
						<select class="form-control-select" name="parentProduct">
				...
				<li class="form-line" data-type="control_textbox" id="id_49"><label
					class="form-label form-label-left form-label-auto" id="label_49"
					for="input_49"> Product Name </label>
					<div id="cid_49" class="form-input">
						<input type="text" class="form-control" class="form-control"
							name="price" />
				...
				<li class="form-line" data-type="control_number" id="id_50"><label
					class="form-label form-label-left form-label-auto" id="label_50"
					for="input_50"> Product Rate </label>
					<div id="cid_50" class="form-input">
						<input type="text" class="form-control" class="form-control"
							name="rate" />
					</div></li>
				<li class="form-line" data-type="control_number" id="id_51"><label
					class="form-label form-label-left form-label-auto" id="label_51"
					for="input_51"> Product Stock </label>
					<div id="cid_51" class="form-input">
						<input type="text" class="form-control"
							class="form-control" name="stock" />
					</div></li>
				<li class="form-line" data-type="control_number" id="id_57"><label
					class="form-label form-label-left form-label-auto" id="label_57"
					for="input_57"> Product Total Sell </label>
					<div id="cid_57" class="form-input">
						<input type="text" class="form-control"
							class="form-control" name="stock" />
					</div></li>
				<li class="form-line" data-type="control_number" id="id_52"><label
					class="form-label form-label-left form-label-auto" id="label_52"
					for="input_52"> Product MRP </label>
					<div id="cid_52" class="form-input">
						<input type="text" class="form-control" class="form-control"
							name="mrp" />
					</div></li>
				<li class="form-line" data-type="control_number" id="id_53"><label
					class="form-label form-label-left form-label-auto" id="label_53"
					for="input_53"> Product Cost Price </label>
					<div id="cid_53" class="form-input">
						<input type="text" class="form-control" class="form-control"
							name="costPrice" />
					</div></li>
				<li class="form-line" data-type="control_number" id="id_55"><label
					class="form-label form-label-left form-label-auto" id="label_55"
					for="input_55"> Product Case Size </label>
					<div id="cid_55" class="form-input">
						<input type="text" class="form-control" class="form-control"
							name="caseSize" />
					</div></li>
				<li class="form-line" data-type="control_number" id="id_56"><label
					class="form-label form-label-left form-label-auto" id="label_56"
					for="input_56"> Product Weight Per Pieces </label>
					<div id="cid_56" class="form-input">
						<input type="text" class="form-control" class="form-control"
							name="weightPerPieces" />
					</div></li>
				<li class="form-line" data-type="control_textarea" id="id_6"><label
					class="form-label form-label-top" id="label_6" for="input_6">
						Comments About Product : </label>
					<div id="cid_6" class="form-input-wide">
						<div class="form-textarea-limit">
							<span> <textarea id="input_6" class="form-textarea"
									name="description" cols="50" rows="5" data-component="textarea"></textarea>
...
<img src="/app-assets/images/name1.jpg" />
