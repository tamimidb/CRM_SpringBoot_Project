...
<link rel="stylesheet"
	href="resources/assets/css/assign/assign-style.css">
		...
		<div class="assign-image">
			...
			<div class="bottom__header">
				<div class="bottom__header__left">
					<h4 class="bottom__header__title">Core Service</h4>
				</div>
				<div class="bottom__header__right">
					...
					<button class="bottom__header__button__saveAndNew">Save
						and New</button>
					<a href="service-report"><input type="button"
			...
			<div class="assign-body">
				...
				<table class="assign-table">
					...
					<tr>
						<td><label for="name" class="field-label">Business</label></td>
						<td><select id="selectBusiness" class="form-control-select">
					...
					<tr>
						<td><label for="serviceCode" class="field-label">Service
								Code</label></td>
						<td><input type="text" class="form-control"
							name="serviceCode" id="serviceCode" /></td>
					</tr>

					<tr>
						<td><label for="serviceType" class="field-label"
							id="business-field">Service Type</label></td>
						<td><select class="form-control-select" name="serviceType">
					...
					<tr>
						<td><label for="serviceName" class="field-label">Service
								Name</label></td>
						<td><input type="text" class="form-control"
							name="serviceName" id="serviceName" /></td>
					</tr>

					<tr>
						<td><label for="serviceRate" class="field-label">Service
								Rate</label></td>
						<td><input type="text" class="form-control"
							name="serviceRate" id="serviceName" /></td>
					</tr>

					<tr>
						<td><label for="serviceStatus" class="field-label"
							id="business-field">Service Status</label></td>
						<td><select class="form-control-select" name="serviceStatus">
								<option>Please Select</option>
					...
					<tr>
						<td><label class="field-label" for="serviceDescription">Description</label>
						</td>

						<td><textarea type="textarea" class="form-control"
								name="serviceDescription"></textarea></td>
					</tr>
					...
					<input type="hidden" name="businessNumOfEmployees"
						id="businessNumOfEmployees" />
