...
<section class="content-header" style="background-color: aqua;">
	...
	<div class="content-wrapper" style="background-color: aqua;">
        ...
        <form action="/task/tasksave" method="post">
            <div class="contact-image">
                ...
                <div class="bottom__header">
                    ...
                    <div class="bottom__header__right">
                        <a href="/task/taskSave"><input type="submit" class="bottom__header__button__save" value="Save"/></a>  
                        <button class="bottom__header__button__saveAndNew">Save and New</button>
                        <a href="/task/taskreport"><input type="button" class="bottom__header__button__cancel" value="Cancel"></a>                    
                    </div>
                </div>
                <!--Header End-->
