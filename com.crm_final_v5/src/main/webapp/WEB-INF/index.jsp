			...
			<!-- ./col -->
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-warning">
						...
						<a href="/lead/leadreport" class="small-box-footer">More info <i
				...
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-success">
						...
						<a href="/marketing/show" class="small-box-footer">More info <i
							class="fas fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<!-- ./col -->
...
<script src="/app-assets/dist/js/pages/dashboard3.js"></script>