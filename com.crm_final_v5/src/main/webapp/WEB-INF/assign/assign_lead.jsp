...
<html>
                    ...
                    <table class="assign-table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select id="selectAssignCRM" class="form-control-select">
                                    <c:forEach items="${map.assignCRMs}" var="crm">
                        ...
                        <tr>
                            <td>
                                <label for="crm" class="field-label">Business Name</label>
                            </td>
                            <td>
 ...
 <jsp:include page="/WEB-INF/common/footer.jsp" />
        ...
        <script>
//MY WORK HAS BEEN BBEGUN FROM HERE
            ...
            $("#selectAssignCRM").change(function () {
                getAssignCRM();
            });
            ...
            function getAssignCRM() {

                $.ajax({
                    url: 'getAssignCRM/' + $("#selectAssignCRM :selected").val(),
                    type: 'GET',
                    dataType: 'json',
                    success: function (data) {
                        //$("#id").val(data.id);
