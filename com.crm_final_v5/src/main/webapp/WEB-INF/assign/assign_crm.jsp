		...
		<div class="assign-image">
			...
			<div class="bottom__header">
				<div class="bottom__header__left">
					<h4 class="bottom__header__title">Assign Customer Relationship
						Manager</h4>
				</div>
				<div class="bottom__header__right">
					<a href="assignCRM"><input type="submit"
						class="bottom__header__button__save" value="Save" /></a>
					...
					<a href="assignreport"><input type="button"
			...
			<div class="assign-body">
				...
				<table class="assign-table">
					<tr>
						<td><label for="crm" class="field-label">CRM</label></td>
						<td>
							<!--id to catch the value from ajax--> <select id="selectCRM"
							class="form-control-select">
								<c:forEach items="${map.crmlist}" var="crm">
									<option value="${crm.id}">${crm.crmFirstName}
										${crm.crmLastName}</option>
								</c:forEach>
						</select>
						</td>
					</tr>
