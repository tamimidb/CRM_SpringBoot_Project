...
<link rel="alternate" type="application/json+oembed"
	href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F212603360251442"
	title="oEmbed Form">
<link rel="alternate" type="text/xml+oembed"
	href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F212603360251442"
	title="oEmbed Form">
<meta property="og:title" content="Home Loan Application">
<meta property="og:url"
	content="https://form.jotform.com/212603360251442">
<meta property="og:description"
	content="Please click the link to complete this form.">
<meta name="slack-app-id" content="AHNMASS8M">
<link rel="shortcut icon" href="https://cdn.jotfor.ms/favicon.ico">
<link rel="canonical" href="https://form.jotform.com/212603360251442" />
<meta name="viewport"
	content="width=device-width, initial-scale=1.0, maximum-scale=2.0, user-scalable=1" />
<meta name="HandheldFriendly" content="true" />
<title>Home Loan Application</title>
<link href="https://cdn01.jotfor.ms/static/formCss.css?3.3.27726"
	rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet"
	href="https://cdn02.jotfor.ms/css/styles/nova.css?3.3.27726" />
<style type="text/css">
@media print {
	.form-section {
...
<link type="text/css" rel="stylesheet"
	href="https://cdn03.jotfor.ms/themes/CSS/5495488a700cc478508b4567.css?themeRevisionID=58c4deb39a11c7b8878b4567" />
<link type="text/css" rel="stylesheet"
	href="https://cdn01.jotfor.ms/css/styles/payment/payment_feature.css?3.3.27726" />
<style type="text/css">
...
.form-radio-item:not(#foo) .form-radio-other, .form-radio-item:not(#foo) .form-checkbox-other
	{
...
.form-radio-item:not(#foo) .form-checkbox-other-input, .form-radio-item:not(#foo) .form-radio-other-input
	{
	margin: 0;
}
...
.form-checkbox-item:not(#foo) label:after {
	background-color: #ffffff;
	box-shadow: 0 2px 0 0 #ffffff, 2px 2px 0 0 #ffffff, 4px 2px 0 0 #ffffff,
		6px 2px 0 0 #ffffff;
...
.form-checkbox-item:not(#foo) label:after {
	background-color: #ffffff;
	box-shadow: 0 3px 0 0 #ffffff, 3px 3px 0 0 #ffffff, 6px 3px 0 0 #ffffff,
		8px 3px 0 0 #ffffff;
	-moz-transform: rotate(-45deg);
	-webkit-transform: rotate(-45deg);
	-o-transform: rotate(-45deg);
...
.supernova {
	...
	background-image:
		url("https://www.jotform.com/uploads/formgallery/form_files/StockSnap_PQBKOX33PD.12.jpg");
}
...
<script src="https://cdn02.jotfor.ms/static/prototype.forms.js"
	type="text/javascript"></script>
<script src="https://cdn03.jotfor.ms/static/jotform.forms.js?3.3.27726"
	type="text/javascript"></script>
<script type="text/javascript">	JotForm.newDefaultTheme = false;
	JotForm.extendsNewTheme = false;
	JotForm.newPaymentUIForNewCreatedForms = false;

   JotForm.setConditions([{"action":[{"id":"action_1615984465436","visibility":"Show","isError":false,"field":"22"}],"id":"1615984474859","index":"0","link":"Any","priority":"0","terms":[{"id":"term_1615984465436","field":"39","operator":"equals","value":"Yes","isError":false}],"type":"field"}]);
...
if (window.JotForm && JotForm.accessible) $('input_6').setAttribute('tabindex',0);
   ...
   JotForm.prepareCalculationsOnTheFly([null,null,null,null,null,null,{"name":"commentsAbout","qid":"6","text":"Comments about Complain:","type":"control_textarea"},{"name":"submit","qid":"7","text":"Submit","type":"control_button"},null,null,null,{"name":"activitiesFor","qid":"11","text":"Activities For Lead","type":"control_head"},null,null,null,null,{"name":"leadName","qid":"16","text":"Lead Name","type":"control_dropdown"},null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,{"description":"","name":"typeName","qid":"42","subLabel":"","text":"Type Name","type":"control_dropdown"},{"description":"","name":"issueName","qid":"43","subLabel":"","text":"Issue Name","type":"control_dropdown"},{"description":"","name":"subject","qid":"44","subLabel":"","text":"Subject","type":"control_dropdown"},{"description":"","name":"dueDate","qid":"45","text":"Due Date","type":"control_datetime"},{"description":"","name":"status","qid":"46","subLabel":"","text":"Status","type":"control_dropdown"},{"description":"","name":"priority","qid":"47","subLabel":"","text":"Priority","type":"control_dropdown"},{"description":"","name":"activititesCode","qid":"48","subLabel":"","text":"Activitites Code","type":"control_textbox"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,null,null,null,null,{"name":"commentsAbout","qid":"6","text":"Comments about Complain:","type":"control_textarea"},{"name":"submit","qid":"7","text":"Submit","type":"control_button"},null,null,null,{"name":"activitiesFor","qid":"11","text":"Activities For Lead","type":"control_head"},null,null,null,null,{"name":"leadName","qid":"16","text":"Lead Name","type":"control_dropdown"},null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,{"description":"","name":"typeName","qid":"42","subLabel":"","text":"Type Name","type":"control_dropdown"},{"description":"","name":"issueName","qid":"43","subLabel":"","text":"Issue Name","type":"control_dropdown"},{"description":"","name":"subject","qid":"44","subLabel":"","text":"Subject","type":"control_dropdown"},{"description":"","name":"dueDate","qid":"45","text":"Due Date","type":"control_datetime"},{"description":"","name":"status","qid":"46","subLabel":"","text":"Status","type":"control_dropdown"},{"description":"","name":"priority","qid":"47","subLabel":"","text":"Priority","type":"control_dropdown"},{"description":"","name":"activititesCode","qid":"48","subLabel":"","text":"Activitites Code","type":"control_textbox"}]);}, 20); 
</script>
</head>
<body>
	<form class="jotform-form" action="/task/activitiesSave" method="post"
		name="form_212603360251442" id="212603360251442"
		accept-charset="utf-8" autocomplete="on">
		<input type="hidden" name="formID" value="212603360251442" /> <input
		...
		<div role="main" class="form-all">
			<ul class="form-section page-section">
					...
					<div class="form-header-group  header-large">
						<div class="header-text httal htvam">
							<h1 id="header_11" class="form-header" data-component="header">
								Activities For Lead</h1>
						</div>
					</div>
				</li>
				<li class="form-line" data-type="control_textbox" id="id_48"><label
					class="form-label form-label-left form-label-auto" id="label_48"
					for="input_48"> Activitites Code </label>
					<div id="cid_48" class="form-input">
						<input type="text" id="input_48" name="q48_activititesCode"
				...
				<li class="form-line jf-required" data-type="control_dropdown"
					id="id_16"><label
					class="form-label form-label-left form-label-auto" id="label_16"
					for="input_16"> Lead Name <span class="form-required">
							* </span>
				</label>
					<div id="cid_16" class="form-input jf-required">
					<select id="leadName" name="leadName"
								class="form-control-select">
									<c:forEach items="${LeadFeedback}" var="lead">
										<option value="${lead.leadFirstName} ${ lead.leadLastName}">${lead.leadFirstName}
											${lead.leadLastName}</option>
									</c:forEach>
							</select> <input type="hidden" name="selectLead" id="selectLead" />
					</div></li>
				<li class="form-line jf-required" data-type="control_dropdown"
					id="id_42"><label
					class="form-label form-label-left form-label-auto" id="label_42"
					for="input_42"> Type Name <span class="form-required">
							* </span>
				</label>
					<div id="cid_42" class="form-input jf-required">
						<select id="type" name="type"
								class="form-control-select">
									<c:forEach items="${LeadFeedback}" var="lead">
										<option value="${lead.feedbackType}">${lead.feedbackType}</option>
									</c:forEach>
							</select> <input type="hidden" name="selectType" id="selectType" />
						
					</div></li>
				<li class="form-line jf-required" data-type="control_dropdown"
					id="id_43"><label
					class="form-label form-label-left form-label-auto" id="label_43"
					for="input_43"> Issue Name <span class="form-required">
							* </span>
				</label>
					<div id="cid_43" class="form-input jf-required">
					<select id="isueeName" name="isueeName"
								class="form-control-select">
									<c:forEach items="${LeadFeedback}" var="lead">
										<option value="${lead.selectedName}">${lead.selectedName}</option>
									</c:forEach>
							</select> <input type="hidden" name="selectedIssue" id="selectedIssue" /></td>
						
					</div></li>
				<li class="form-line jf-required" data-type="control_dropdown"
					id="id_44"><label
					class="form-label form-label-left form-label-auto" id="label_44"
					for="input_44"> Subject <span class="form-required">
							* </span>
				</label>
					<div id="cid_44" class="form-input jf-required">
					<select class="form-control-select"
								name="activitiesSubject" id="activitiesSubject">
									<option>Email</option>
									<option>Call</option>
				...
				<li class="form-line" data-type="control_datetime" id="id_45">
					...
					id="label_45" for="lite_mode_45"> Due Date </label>
					<div id="cid_45" class="form-input">
						<input type="date" class="form-control"
								name="activitiesDueDate" id="activitiesDueDate" />
					</div>
				</li>
				<li class="form-line jf-required" data-type="control_dropdown"
					id="id_46"><label
					class="form-label form-label-left form-label-auto" id="label_46"
					for="input_46"> Status <span class="form-required">
							* </span>
				</label>
					<div id="cid_46" class="form-input jf-required">

						<select class="form-control-select"
								name="activitiesStatus" id="activitiesStatus">
				...
				<li class="form-line jf-required" data-type="control_dropdown"
					id="id_47"><label
					class="form-label form-label-left form-label-auto" id="label_47"
					for="input_47"> Priority <span class="form-required">
							* </span>
				</label>
					<div id="cid_47" class="form-input jf-required">
						<select class="form-control-select"
								name="activitiesPriority" id="activitiesPriority">
									<option>High</option>
				...
				<li class="form-line" data-type="control_textarea" id="id_6"><label
					class="form-label form-label-top" id="label_6" for="input_6">
						Comments about Complain: </label>
					<div id="cid_6" class="form-input-wide">
						<div class="form-textarea-limit">
							<span> <textarea id="input_6" class="form-textarea"
									name="activitiesDescription" cols="50" rows="5"
									data-component="textarea"></textarea>
								<div class="form-textarea-limit-indicator">
									<span data-limit="300" type="Words" data-minimum="-1"
										data-typeminimum="None" id="input_6-limit"> 0/300 </span>
								</div>
							</span>
						</div>
					</div></li>
		...
		<input type="hidden" class="simple_spc" id="simple_spc"
			name="simple_spc" value="212603360251442" />
		<script type="text/javascript">
  var all_spc = document.querySelectorAll("form[id='212603360251442'] .si" + "mple" + "_spc");
for (var i = 0; i < all_spc.length; i++)
{
  all_spc[i].value = "212603360251442-212603360251442";
}
  </script>
...
<script>
	...
	$("#selectLead").val($("#leadName :selected").text());
		$("#leadName").on("change", function(){
			$("#selectLead").val($("#leadName :selected").text());
		}
			
			$("#selectType").val($("#type :selected").text());
			$("#type").on("change", function(){
				$("#selectType").val($("#type :selected").text());
			}
				
				$("#selectedIssue").val($("#isueeName :selected").text());
				$("#isueeName").on("change", function(){
					$("#selectedIssue").val($("#isueeName :selected").text());
				}
