...
CREATE TABLE `customer_complain` (
  ...
  `customer_complain_code` varchar(255) DEFAULT NULL,
  `customer_complain_details` varchar(255) DEFAULT NULL,
  `customer_complain_title` varchar(255) DEFAULT NULL,
...
LOCK TABLES `customer_complain` WRITE;
/*!40000 ALTER TABLE `customer_complain` DISABLE KEYS */;
/*!40000 ALTER TABLE `customer_complain` ENABLE KEYS */;
UNLOCK TABLES;
