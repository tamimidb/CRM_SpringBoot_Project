...
CREATE TABLE `customer_feedback` (
  ...
  `customer_audio_clip` varchar(255) DEFAULT NULL,
  `customer_email` varchar(255) DEFAULT NULL,
  `customer_mobile` varchar(255) DEFAULT NULL,
  `customer_opinion_on_services` varchar(255) DEFAULT NULL,
  `customer_opinion_reason` varchar(255) DEFAULT NULL,
  `customer_other_opinion` varchar(255) DEFAULT NULL,
  `customer_satisfaction_level` varchar(255) DEFAULT NULL,
