...
--
-- Table structure for table `assign_crm`
--

DROP TABLE IF EXISTS `assign_crm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `assign_crm` (
...
--
-- Dumping data for table `assign_crm`
--

LOCK TABLES `assign_crm` WRITE;
/*!40000 ALTER TABLE `assign_crm` DISABLE KEYS */;
/*!40000 ALTER TABLE `assign_crm` ENABLE KEYS */;
UNLOCK TABLES;
